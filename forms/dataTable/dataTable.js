...
//who else was added button
btnAdd.onclick=function(){
  NSB.MsgBox('Kanye West was also added! Search table to see values.')
}


//adding my own data to the table
dataTable.onshow=function(){
  data1.push(["Jack Hybl", "Cheif Executive", "Colorado Springs", "1234", "2020/09/25", "$420,000"])
  data1.push(["Elon Musk", "Cheif Executive", "Pretoria", "1235", "1999/09/25", "$420,000,000"])
  data1.push(["Kanye West", "Artist", "Chicago", "1236", "2000/10/25", "$420,000,340"])
  NSB.MsgBox('Jack Hybl & Elon Musk were added! Search table to see values.')
}
